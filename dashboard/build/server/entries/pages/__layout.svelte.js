import { g as getContext, c as create_ssr_component, a as subscribe, e as escape, v as validate_component } from "../../immutable/chunks/index-2f611cd8.js";
import { R as Rolling } from "../../immutable/chunks/Rolling-d266fc8f.js";
import { p as popupData, u as updateSite } from "../../immutable/chunks/Popup-cb8581a2.js";
/* empty css                                                                     */const app = "";
const getStores = () => {
...
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>RaceCord Modmail ${escape(((_a = $page.url) == null ? void 0 : _a.pathname.split("/")[1]) ? `| ${$page.url.pathname.split("/")[1][0].toUpperCase()}${$page.url.pathname.split("/")[1].slice(1)}` : "")}</title>`, ""}`, ""}
