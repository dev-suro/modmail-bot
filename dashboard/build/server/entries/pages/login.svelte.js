import { c as create_ssr_component, h as createEventDispatcher, e as escape, i as null_to_empty, d as add_attribute, v as validate_component } from "../../immutable/chunks/index-2f611cd8.js";
...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>RaceCord Modmail | Login</title>`, ""}`, ""}

<div class="${"container svelte-b5o5q1"}"><h1 class="${"svelte-b5o5q1"}">racecord modmail</h1>
